	...
	************************************************************************************************************/
	...
	function showColorPicker(inputObj,formField)
	{
		...
		color_picker_div.style.left = '0px';
		color_picker_div.style.top  = '0px';
		color_picker_form_field = formField;
		color_picker_active_input = inputObj;
	}

	function openColorPicker(inputObj, targetId, colorpickerURI)
	{
		WindowColorPicker = window.open(colorpickerURI+'?targetId='+targetId,'ColorPicker','height=200,width=300');
		WindowColorPicker.moveTo(colorPickerGetLeftPos(inputObj),(colorPickerGetTopPos(inputObj) + inputObj.offsetHeight + 2));
	}
