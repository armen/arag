...
{arag_block}
    ...
    {arag_form uri="multisite/backend/settings/user_blocking" method="post"}
    <table border="0" dir="{dir}" width="100%">
    <tr>
        <td align="{right}" width="250">_("Number of verify attempts before blocking"):</td>
    ...
    <tr>
        <td align="{right}" width="250" valign="top">_("Block action"):</td>
        <td>{html_radios name="block_action" options=$blockoptions selected=$blockselected separator="<br />"}</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td>
