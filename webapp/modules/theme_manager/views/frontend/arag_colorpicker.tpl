...
<div id="color{$ending}_container">
    <input type="text" name="color{$ending}" id="color{$ending}" value="{$color|smarty:nodefaults|default:null}" size="7" dir="ltr" style="background-color: {$color|smarty:nodefaults|default:null};" />
