...
$config['base_url'] .= ((isset($_SERVER['HTTPS'])&&$_SERVER['HTTPS']=='on')?'s':'');
$config['base_url'] .= '://';
$config['base_url'] .= $_SERVER['SERVER_NAME'];
$config['base_url'] .= substr($_SERVER['SCRIPT_NAME'], 0, strpos($_SERVER['SCRIPT_NAME'], 
...
| www.your-site.com/index.php?m=module&c=controller&f=function
|
...
|
*/
$config['sess_cookie_name']     = 'arag_session';
